...
class _NeedBloodState extends State<NeedBlood> {
  ...
  final String url =
      'https://script.google.com/macros/s/AKfycbxOLElujQcy1-ZUer1KgEvK16gkTLUqYftApjNCM_IRTL3HSuDk/exec?id=1_0rUVs1WFmNJfuWtiGmm7vEetqpDt-Rs561076-sCBQ&sheet=Sheet1';

  // TODO: Change id of spreadsheet
                    ...
                    : FlatButton(
                        ...
                        onPressed: () {
                          Fluttertoast.showToast(
                              msg: 'Click On Mobile Number to call',
...
class Detailes extends StatelessWidget {
  ...
  _makingPhoneCall(var telPhoneNo) async {
    var url = 'tel://' + telPhoneNo.toString();
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            FlatButton(
                onPressed: () => _makingPhoneCall(data['Mobile_Number']),
                child: buildContainer(
                    'Mobile Number: ', data['Mobile_Number'].toString())),
